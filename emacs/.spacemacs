...
values."
  (setq-default
   ...
   ;; `+distribution'. For now available distributions are `spaceSource Code Promacs-base'
   ;; or `spacemacs'. (default 'spacemacs)
   dotspacemacs-distribution 'spacemacs
   ;; Lazy installation of layers (i.e. layers are installed only when a file
   ;; with a supported type is opened). Source Code ProPossible values are `all', `unused'
...
you should place your code here."
  (global-linum-mode)
  (global-visual-line-mode 1) ; wraps at word boundaries 1 for on, 0 for off.
