...
if has("gui_running") || t_Co >= 256
    ...
    hi SpellBad                     ctermfg=0    ctermbg=209  cterm=none       guifg=#d22f27 guibg=#e28964 gui=none
    hi SpellCap                     ctermfg=0    ctermbg=113  cterm=none       guifg=#d22f27 guibg=#87d75f gui=none
    hi SpellLocal                   ctermfg=0    ctermbg=111  cterm=none       guifg=#d22f27 guibg=#89bdff gui=none
    ...
    hi Error                        ctermfg=0    ctermbg=209                   guifg=#d22f27 guibg=#9da6a9
